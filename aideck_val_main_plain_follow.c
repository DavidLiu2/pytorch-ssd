/*
 * Lightweight validation entry point for the current plain-follow GAP8 app.
 * It loads inputs.hex, runs the generated network once, and emits the final
 * 14-value int32 tensor in a log-friendly format for post-run comparison.
 */
#include "mem.h"
#include "network.h"
