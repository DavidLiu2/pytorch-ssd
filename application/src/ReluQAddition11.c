...
void ReluQAddition11(void *args) {
  unsigned int *real_arg = (unsigned int *) args;
  const int32_t *x = (const int32_t *) real_arg[3];
  const int32_t *x2 = (const int32_t *) real_arg[4];
  ...
  pulp_nn_add_raw_i32_u8(x, x2, y, 32, 32, 6, out_mult_in, out_shift_in, 8192u, "ReluQAddition11");
}
