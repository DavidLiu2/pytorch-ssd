...
void Convolution17(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      y_tile_size_nof = (_i_nof_load+1 == 2) ? 28 : 36;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*32/8;
      y_length_nof_byte = (_i_nof_load+1 == 2)   ? 112 : 144;
      W_tile_size_nof = (_i_nof_load+1 == 2) ? 28 : 36;
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 36, 3*3, 64, 3*3, 64, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 4368);
    ...
    b = (uint8_t *) (l1_buffer + 25128 + _i_nof_load*144);
    W = (uint8_t *) (l1_buffer + 4368);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 8, 2, 36, 8, 64, 0, 0, 0, 0, 0, 0, 32);
