...
void Convolution68(
  ...
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 19624);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 16, 16, 8, 16, 8,  2, 2,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 18448);
    ...
    b = (uint8_t *) (l1_buffer + 19624 + _i_nof_load*64);
    W = (uint8_t *) (l1_buffer + 18448);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 16, 16, 16, 16, 16, 0, 0, 0, 0, 0, 0, 32);
