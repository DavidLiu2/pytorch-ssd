...
void Convolution69(
  ...
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 7464);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    ...
    b = (uint8_t *) (l1_buffer + 7464 + _i_nof_load*64);
    W = (uint8_t *) (l1_buffer + 5136);
