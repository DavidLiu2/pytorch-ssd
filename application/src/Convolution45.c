...
void Convolution45(
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+864;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 24472);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      x_tile_size_nif = (_i_nif_load+1 == 2) ? 48 : 48;
      ...
      x_length_nif_byte = (_i_nif_load+1 == 2)   ? 48 : 48;
      ...
      y_tile_size_nof = (_i_nof_load+1 == 2) ? 48 : 48;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*32/8;
      y_length_nof_byte = (_i_nof_load+1 == 2)   ? 192 : 192;
      W_tile_size_nof = (_i_nof_load+1 == 2) ? 48 : 48;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 10, 10, 48, 10, 96,  2, 2,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 24016);
    ...
    b = (uint8_t *) (l1_buffer + 24472 + _i_nof_load*192);
    W = (uint8_t *) (l1_buffer + 24016);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 10, 10, 48, 10, 96, 0, 0, 0, 0, 0, 0, 32);
