...
// ULTRA_VERBOSE                  False
// verbose_log                    
// node                           <dory.Parsers.HW_node.HW_node object at 0x725d345861c0>
// sdk                            gap_sdk
// number_of_clusters             1
// optional_type                  8bit
// func_name                      ReluPooling29
// flag_DW                        0
...
// x_tile_size_h                  4
// x_tile_size_w                  4
// x_tile_size_byte               1280
// x_tile_size_nif_byte           80
// x_stride_w_byte                320
// x_stride_c_byte                80
// y_h                            1
// y_w                            1
...
// x_tile_size_nif_last           80
// x_tile_size_nif_byte_last      80
...
void ReluPooling29(
 ...
 uint8_t *im2col;
  ...
  for(iter=0; iter<1*1*1; iter++) {
    ...
    DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 4, 4, 80, 4, 80,  0, 0,0, pad_offset_h, pad_offset_w, 0, 8);
...
// aggiungere padding su tutti i lati, acc_out, and filter asymettric
    ...
    DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 1, 1, 80, 1, 80, 0, 0, 0, 0, 0, 0, 8);
