...
// ULTRA_VERBOSE                  False
// verbose_log                    
// node                           <dory.Parsers.HW_node.HW_node object at 0x7d5d131adf70>
// sdk                            gap_sdk
...
// y_tile_size_h_last             5
// y_tile_size_w_last             5
...
void Addition54(
  ...
  for(iter=0; iter<1*1*1; iter++) {
    ...
    DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 5, 5, 16, 5, 16,  0, 0,0, 0, 0, 0, 32);
    ...
    DMA_copy_x2.ext = dory_get_tile_3d(l2_x2, _i_h_load, _i_w_load, _i_nif_load, 5, 5, 16, 5, 16,  0, 0,0, 0, 0, 0, 32);
    DMA_copy_x2.loc = (l1_buffer + 3216);
    ...
    y_tile_size_h   = (last_h)   ? 5 : 5;
    y_tile_size_w   = (last_w)   ? 5 : 5;

    x = (uint8_t *) (l1_buffer + 0);
    x2 = (uint8_t *) (l1_buffer + 3216);
