...
void ReluConvolution23(
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+46080;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 25560);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 2)   ? 3 : 7;
      x_tile_size_w   = (_i_w_load+1 == 2)   ? 5 : 5;
      ...
      if(_i_w_load > 0)
        pad_offset_w = 1;
      y_tile_size_h   = (_i_h_load+1 == 2)   ? 1 : 3;
      y_tile_size_w   = (_i_w_load+1 == 2)   ? 2 : 2;
      y_tile_size_nof = (_i_nof_load+1 == 2) ? 40 : 40;
      y_tile_size_byte = y_tile_size_nof*y_tile_size_h*y_tile_size_w*8/8;
      y_length_nof_byte = (_i_nof_load+1 == 2)   ? 40 : 40;
      W_tile_size_nof = (_i_nof_load+1 == 2) ? 40 : 40;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 7, 5, 64, 8, 64,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    b = (uint8_t *) (l1_buffer + 25560 + _i_nof_load*160);
    W = (uint8_t *) (l1_buffer + 2496);
    y = (uint8_t *) (l1_buffer + 2248);
    p_r = 0;
    p_l = 0;
    p_t = 0;
    p_b = 0;
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 3, 2, 40, 4, 80, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 2248);
