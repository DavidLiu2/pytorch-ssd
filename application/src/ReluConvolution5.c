...
void ReluConvolution5(
  ...
  im2col = l1_buffer + 27064;
  volatile uint8_t *pwt_buffer;
  pwt_buffer = im2col + 480;
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 5)   ? 17 : 17;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 17, 80, 16, 80, 48,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 8, 40, 16, 40, 48, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 21768);
