...
void Convolution40(
  ...
  DMA_copy_W.stride_2d = 16;
  DMA_copy_W.stride_1d = 16;
  DMA_copy_W.number_of_2d_copies = 96;
  ...
  im2col = l1_buffer + 33960;
  uint16_t out_shift = out_shift_in;

  ////////////////////////////
  // First tile transfering //
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+1536;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 33576);
  DMA_copy_bias.number_of_2d_copies = 1;
  DMA_copy_bias.number_of_1d_copies = 1;
  DMA_copy_bias.length_1d_copy = (uint16_t) 384;
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      x_tile_size_h   = (_i_h_load+1 == 2)   ? 2 : 8;
      ...
      if(_i_w_load > 0)
        pad_offset_w = 0;
      y_tile_size_h   = (_i_h_load+1 == 2)   ? 2 : 8;
      ...
      y_length_nof_byte = (_i_nof_load+1 == 1)   ? 384 : 384;
      W_tile_size_nof = (_i_nof_load+1 == 1) ? 96 : 96;
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 8, 10, 16, 10, 16,  0, 0,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 96, 1*1, 16, 1*1, 16, 0,0,0,0,0,0, 8);
    ...
    b = (uint8_t *) (l1_buffer + 33576 + _i_nof_load*384);
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 8, 10, 96, 10, 96, 0, 0, 0, 0, 0, 0, 32);
