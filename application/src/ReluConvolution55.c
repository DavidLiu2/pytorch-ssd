...
void ReluConvolution55(
  ...
  for(iter=0; iter < total_tiles; iter++) {
    ...
    pi_cl_team_barrier(0);
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_load, _i_w_load, _i_nof_load, 5, 5, 96, 5, 96, 0, 0, 0, 0, 0, 0, 8);
