...
void ReluConvolution11(
  ...
  ////////////////////////////
  DMA_copy_bias.ext = (uint32_t) l2_W+13824;
  DMA_copy_bias.loc = (uint32_t) (l1_buffer + 25128);
  ...
  for(iter=0; iter < total_tiles; iter++) {
    // check if last in any dimension
      ...
      {
        DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 16, 16, 32, 16, 32,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      {
        DMA_copy_W.ext = dory_get_tile_3d(l2_W, _i_nof_load, 0, _i_nif_load, 48, 3*3, 32, 3*3, 32, 0,0,0,0,0,0, 8);
        DMA_copy_W.loc = (l1_buffer + 11280);
    ...
    b = (uint8_t *) (l1_buffer + 25128 + _i_nof_load*192);
    W = (uint8_t *) (l1_buffer + 11280);
