...
void execute_layer_fork(void *args) {
  ...
  switch (layer_args->layer_id)
  {
    ...
    case 3:
      ...
      break;
    case 4:
      pi_cl_team_fork(NUM_CORES, (void *)ReluAddition4, args);
      break;
    case 5:
      pi_cl_team_fork(NUM_CORES, (void *)ReluConvolution5, args);
      break;
    case 6:
      pi_cl_team_fork(NUM_CORES, (void *)ReluConvolution6, args);
      break;
    case 7:
    ...
    case 8:
      ...
      break;
    case 9:
      pi_cl_team_fork(NUM_CORES, (void *)ReluAddition9, args);
      break;
    case 10:
      pi_cl_team_fork(NUM_CORES, (void *)ReluConvolution10, args);
      break;
    case 11:
    ...
    case 12:
      ...
      break;
    case 13:
      pi_cl_team_fork(NUM_CORES, (void *)ReluPooling13, args);
      break;
    case 14:
      pi_cl_team_fork(NUM_CORES, (void *)FullyConnected14, args);
      break;
  }
...
void network_run_wait(struct network_run_token token)
{
  ...
  print_perf("Final", cycle_network_execution, 24035856);
}
...
*/
    ...
    if (L3_output_layers[i]==1) {
      ...
      checksum(i + 1 < 15 ? "L2 output" : "final output",
  ...
  //memcpy(L2_output, l2_final_output, activations_out_size[14]); // BUGGY!
  for (int i=0; i<activations_out_size[14]; i++)
